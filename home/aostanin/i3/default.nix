      ...
      profiles = {
        ...
        "ThinkPad Docked Home" = {
          fingerprint = {
            ...
            eDP1 = "";
          };
          config = {
            DP2-1 = {
              enable = true;
